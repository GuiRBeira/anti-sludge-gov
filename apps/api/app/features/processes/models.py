# app/features/processes/models.py
...
if TYPE_CHECKING:
    ...
    from app.features.analysis_results.models import ResultadoAnalise, CriterioBarreira, CriterioImpacto
...
class Etapa(Base):
    ...
    # PostgreSQL INTERVAL maps to Python timedelta
    ...
    # Corrigido: Etapa possui resultados analise
    resultados: Mapped[List["ResultadoAnalise"]] = relationship(
        "ResultadoAnalise",
        back_populates="etapa",
        passive_deletes=True,
