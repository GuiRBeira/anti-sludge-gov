...
from sqlalchemy import (
    String, Text, Integer, DateTime, ForeignKey, UniqueConstraint, func
)
...
class Categoria(Base):
    ...
    etapas: Mapped[List["Etapa"]] = relationship(  # Etapa existe em process.py
        back_populates="categoria",
        passive_deletes=True,
    )
...
class TipoCriterio(Base):
    ...
    tipo_comportamento: Mapped["TipoComportamento"] = relationship(back_populates="mapeamentos_criterios")
...
class EscalaAvaliacao(Base):
    ...
    tipo_comportamento: Mapped[Optional["TipoComportamento"]] = relationship(back_populates="escalas")
